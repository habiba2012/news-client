                ...
                <Row className="align-items-center justify-content-center banner">
                    <Col md={6}>
                        <Fade left duration={2000} distance="40px">
                            <Image src="https://img.freepik.com/free-vector/about-us-concept-illustration_114360-639.jpg?size=338&ext=jpg" fluid />
                        </Fade>
                    </Col>
                    <Col md={4} className="p-md-5 mt-md-0 mt-4">
                        <Fade right duration={2000} distance="40px">
                            ...
                            <Button
                                className="btn-main"
                                href="#pricing" style={{ backgroundColor: "#70c3be" }} >
                                Learn More
                            </Button>
                        </Fade>
                    </Col>
